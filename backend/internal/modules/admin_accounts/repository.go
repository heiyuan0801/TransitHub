...
var workspaceDeleteStatements = []workspaceDeleteStatement{
	...
	{Name: "connection_health_embed_configs", SQL: `DELETE FROM connection_health_embed_configs WHERE user_id = $1 AND admin_account_id = $2`},
...
var legacyWorkspaceTables = []workspaceTableDescriptor{
	...
	{Name: "connection_health_embed_configs", WorkspaceColumn: "admin_account_id"},
