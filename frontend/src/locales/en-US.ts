export default {
  ...
  admin: {
    ...
    menu: {
      ...
      connectionHealthEmbed: 'Online Check Embed',
    ...
    connectionHealth: {
      ...
      embed: {
        ...
        standaloneTitle: 'Online check embed',
        standaloneDescription: 'Configure the online model check and generate an embed page that can be placed on any website. Only check results are returned; API keys stay server-side.',
        standaloneSettings: 'Embed settings',
        openAccessHint: 'No origin allowlist is required. The generated page can be opened from any site while the access token still protects the API.',
        generatedUrl: 'Embed page URL',
        generatedCode: 'iframe code',
        copyUrl: 'Copy URL',
        copyFailed: 'Copy failed. Please copy it manually.',
        generated: 'A new embed token was generated',
        loading: 'Loading embed settings...',
        interval: 'Probe / refresh interval (sec)',
        intervalHint: 'Each refresh runs the configured API check again. Allowed range: 10–3600 seconds.',
        ...
        customTitle: 'Custom API check',
        customDescription: 'Enter an OpenAI-compatible Chat Completions URL, API key, and model. The key is encrypted server-side and never exposed in the embed.',
        customEnabled: 'Enable custom check',
        customBaseUrl: 'API Base URL',
        customBaseUrlPlaceholder: 'https://api.example.com',
        customApiKey: 'API Key',
        customApiKeyPlaceholder: 'Leave blank to keep the saved key',
        customModel: 'Model name',
        customModelPlaceholder: 'e.g. gpt-4o-mini',
        customProvider: 'Model type',
        ...
        encryptionUnavailable: 'SMTP_ENCRYPTION_KEY is not configured; the API key cannot be stored securely.'
      },
      events: {
