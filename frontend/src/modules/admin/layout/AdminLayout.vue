...
import { LayoutDashboard, Network, Settings, LogOut, Globe, Moon, Sun, Percent, Megaphone, ChevronDown, ArrowRightLeft, FolderTree, Link2, Activity, MessageSquare, Github, Mail, Menu, X, Trophy, Gift, Boxes, CalendarCheck2, Code2 } from 'lucide-vue-next'
...
const menuItems = computed<MenuEntry[]>(() => [
  ...
  { type: 'leaf', name: t('admin.menu.massEmail'), path: '/admin/mass-email', icon: Mail },
  {
    ...
    children: [
      ...
      { name: t('admin.menu.checkin'), path: '/admin/checkin', icon: CalendarCheck2 },
      { name: t('admin.menu.connectionHealthEmbed'), path: '/admin/connection-health-embed', icon: Code2 },
